...
- [ ] CarName: 자동차 이름을 다루는 함수를 구현한다
- [ ] CarName: 자동차 이름 유효성을 검사한다
...
- [ ] RacingCarEntries: 참가 자동차 목록을 관리하는 함수를 구현한다
- [ ] RacingCarEntries: 우승자를 이름 명단을 반환하는 함수를 구현한다
- [ ] Laps: 경기에서 서킷 총 이동 횟수를 관리하는 함수를 구현한다
